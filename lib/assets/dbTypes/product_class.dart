...
/// Abstract base class for all sellable items/services (Vaccines, Packages, Consultations).
...
class Vaccine extends Product {
  ...
  final DateTime? expiryDate; // Expiry if applicable
  final String? storageInstructions; // How to store the vaccine
...
/// Represents a package or bundle of products/services.
class Package extends Product {
  final List<String>
      includedProductIds; // List of Product IDs included in the package
  final String?
  ...
  Package({
    ...
    required super.commonName,
    required super.description,
    required super.price, // Price might be sum of included or a special package price
    super.priceAvacunar,
    super.priceVita,
    super.priceColsanitas,
    required super.imageUrl, // Often a generic package image
    required super.applicableDoctors, // Doctors who handle these packages
